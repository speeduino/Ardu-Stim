...
#define MJR_DEBUG 1 // used for development by Mike501, should be removed in release versions
/*
...
wheels Wheels[MAX_WHEELS] = {
  ...
  #ifdef MJR_DEBUG  
  { rover_mems_test_thirtysix_minus_one_one_one_one_friendly_name, rover_mems_test_thirtysix_minus_one_one_one_one, 0.6, 72, 360 },   // added for testing, can be removed.
  #endif
};
